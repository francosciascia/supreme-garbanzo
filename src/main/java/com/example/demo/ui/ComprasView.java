...
public class ComprasView extends VerticalLayout {
    ...
    private void form(){Dialog d=new Dialog();d.setHeaderTitle("Registrar compra");d.setWidth("min(850px,95vw)");
        ...
        TextField receipt=new TextField("N° comprobante");VerticalLayout rowsLayout=new VerticalLayout();List<Row> rows=new ArrayList<>();Button addItem=new Button("Agregar producto",e->row(rowsLayout,rows,controlarVencimientos));
